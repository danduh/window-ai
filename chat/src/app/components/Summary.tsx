        ...
        <div className="space-y-4">
          <fieldset className="border border-gray-300 rounded-md p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label htmlFor="type" className="block mb-1">Summary Type:</label>
                <select
                  id="type"
                  value={type}
              ...
              <div>
                ...
                <select
                  id="length"
                  value={length}
                  onChange={e => setLength(e.target.value as AISummarizerLength)}
                  className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
              ...
              <div>
                ...
                <select
                  id="format"
                  value={format}
                  onChange={e => setFormat(e.target.value as AISummarizerFormat)}
                  className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
